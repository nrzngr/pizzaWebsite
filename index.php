  ...
  <body>
    ...
    <section class="container">
      ...
      <div class="container-box">
        ...
        <div class="c-mainbox">
          <div class="container-img">
            <img src="./img/EggHD.png" alt="box4" />
          </div>
          <div class="container-text">
            <p>Japanese Eggs</p>
          </div>
    ...
    <section class="about" id="about">
      <div class="about-img">
        <img src="img/big-noodle.png" alt="" />
      </div>
    ...
    <section class="menu" id="menu">
      <div class="main-text">
        ...
        <p>
          We have selected for You<br />
          the most exquisite tastes around the world
        </p>
      </div>
    ...
    <section class="contact" id="contact">
      <div class="main-contact">
        ...
        <div class="contact-content">
          <h4>Delivery</h4>
          <li><a href="#home">GoFood</a></li>
          <li><a href="#about">GrabFood</a></li>
          <li><a href="#menu">ShoppeFood</a></li>
          <li><a href="#contact">Maxim</a></li>
        </div>
    ...
    <div class="last-text">
      <p>© Developed 2023 by Muhammad Ridzki Nugraha</p>
    </div>
